namespace DSPPreamp
{
    partial class frmModels
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label18.Text = "Asymmetry:";
            // 
            // nudDSPDistortionAsymmetry
            // 
            this.nudDSPDistortionAsymmetry.DecimalPlaces = 2;
            this.nudDSPDistortionAsymmetry.Increment = new decimal(new int[] {
            1,
            0,
            0,
            131072});
            this.nudDSPDistortionAsymmetry.Location = new System.Drawing.Point(73, 106);
            this.nudDSPDistortionAsymmetry.Maximum = new decimal(new int[] {
            25,
            0,
            0,
            65536});
            ...
            0,
            65536});
            this.nudDSPDistortionAsymmetry.ValueChanged += new System.EventHandler(this.nudDSPDistortionAsymmetry_ValueChanged);
            // 
            // label2
            // 
            ...
            0,
            0});
            this.nudDSPDistortionVolume.Minimum = new decimal(new int[] {
            50,
            0,
            0,
            -2147483648});
            ...
            0,
            -2147483648});
            this.nudDSPDistortionVolume.ValueChanged += new System.EventHandler(this.nudDSPDistortionVolume_ValueChanged);
            // 
            // label24
            // 
            ...
            // 
            // nudDSPDistortionAlpha
            // 
            this.nudDSPDistortionAlpha.DecimalPlaces = 1;
            this.nudDSPDistortionAlpha.Increment = new decimal(new int[] {
            1,
            0,
            0,
            65536});
            this.nudDSPDistortionAlpha.Location = new System.Drawing.Point(73, 80);
            this.nudDSPDistortionAlpha.Maximum = new decimal(new int[] {
            10,
            0,
            0,
            0});
            ...
            0,
            65536});
            this.nudDSPDistortionAlpha.ValueChanged += new System.EventHandler(this.nudDSPDistortionAlpha_ValueChanged);
            // 
            ...
            // nudPostgainMidQ
            // 
            this.nudPostgainMidQ.DecimalPlaces = 1;
            this.nudPostgainMidQ.Increment = new decimal(new int[] {
            1,
            0,
            0,
            65536});
            ...
            0,
            0});
            this.nudPostgainMidQ.Minimum = new decimal(new int[] {
            2,
            0,
            0,
            65536});
            ...
            0,
            0});
            this.nudPostgainMidQ.ValueChanged += new System.EventHandler(this.nudPostgainMidQ_ValueChanged);
            // 
            // label17
            // 
            ...
            // nudPostgainMidFreq
            // 
            this.nudPostgainMidFreq.Increment = new decimal(new int[] {
            10,
            0,
            0,
            0});
            ...
            0,
            0});
            this.nudPostgainMidFreq.ValueChanged += new System.EventHandler(this.nudPostgainMidFreq_ValueChanged);
            // 
            // label11
            // 
            ...
            this.label6.Text = "Low cut order:";
            // 
            // label5
            // 
            ...
            // nudPregainLowcut
            // 
            this.nudPregainLowcut.Increment = new decimal(new int[] {
            10,
            0,
            0,
            0});
            this.nudPregainLowcut.Location = new System.Drawing.Point(111, 29);
            this.nudPregainLowcut.Maximum = new decimal(new int[] {
            1000,
            0,
            0,
            0});
            ...
            0,
            0});
            this.nudPregainLowcut.ValueChanged += new System.EventHandler(this.nudPregainLowcut_ValueChanged);
            // 
            // label4
            // 
